...
/***/ "./app/javascript/packs/plugins/datatables-fixedheader/js/dataTables.fixedHeader.js":
/*!******************************************************************************************!*\
  !*** ./app/javascript/packs/plugins/datatables-fixedheader/js/dataTables.fixedHeader.js ***!
  \******************************************************************************************/
...
/***/ "./app/javascript/packs/plugins/datatables-fixedheader/js/dataTables.fixedHeader.min.js":
/*!**********************************************************************************************!*\
  !*** ./app/javascript/packs/plugins/datatables-fixedheader/js/dataTables.fixedHeader.min.js ***!
  \**********************************************************************************************/
/*! no static exports found */
...
(function (d) {
  ...
  d.extend(h.prototype, {
    ...
    _matchWidths: function _matchWidths(a, b) {
      var e = function e(b) {
        return d(b, a).map(function () {
          return 1 * d(this).css("width").replace(/[^\d\.]/g, "");
        }).toArray();
      },
          c = function c(a, _c) {
    ...
    _modeChange: function _modeChange(a, b, e) {
      ...
      if ("in-place" === a) {
        if (c.placeholder && (c.placeholder.remove(), c.placeholder = null), this._unsize(b), "header" === b ? c.host.prepend(i) : c.host.append(i), c.floating) c.floating.remove(), c.floating = null;
      } else "in" === a ? (this._clone(b, e), c.floating.addClass("fixedHeader-floating").css("header" === b ? "top" : "bottom", this.c[b + "Offset"]).css("left", f.left + "px"), g(f.width), "footer" === b && c.floating.css("top", "")) : "below" === a ? (this._clone(b, e), c.floating.addClass("fixedHeader-locked").css("top", f.tfootTop - f.theadHeight).css("left", f.left + "px"), g(f.width)) : "above" === a && (this._clone(b, e), c.floating.addClass("fixedHeader-locked").css("top", f.tbodyTop).css("left", f.left + "px"), g(f.width));

      h && h !== j.activeElement && setTimeout(function () {
        h.focus();
      }, 10);
      this.s.scrollLeft.header = -1;
      this.s.scrollLeft.footer = -1;
    ...
    _scroll: function _scroll(a) {
      var b = d(j).scrollTop(),
          ...
          c = this.s.position,
          f;
      this.c.header && (f = this.s.enable ? !c.visible || b <= c.theadTop - this.c.headerOffset ? "in-place" : b <= c.tfootTop - c.theadHeight - this.c.headerOffset ? "in" : "below" : "in-place", (a || f !== this.s.headerMode) && this._modeChange(f, "header", a), this._horizontal("header", e));
      this.c.footer && this.dom.tfoot.length && (b = this.s.enable ? !c.visible || b + c.windowHeight >= c.tfootBottom + this.c.footerOffset ? "in-place" : c.windowHeight + b > c.tbodyTop + c.tfootHeight + this.c.footerOffset ? "in" : "above" : "in-place", (a || b !== this.s.footerMode) && this._modeChange(b, "footer", a), this._horizontal("footer", e));
    }
  });
  h.version = "3.1.8";
  h.defaults = {
...
/***/ 15:
/*!***************************************************************************************************************************************************************************************!*\
  !*** multi ./app/javascript/packs/plugins/datatables-fixedheader/js/dataTables.fixedHeader.js ./app/javascript/packs/plugins/datatables-fixedheader/js/dataTables.fixedHeader.min.js ***!
  \***************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! /Users/jazzzz/Development/eData/data_analysis/app/javascript/packs/plugins/datatables-fixedheader/js/dataTables.fixedHeader.js */"./app/javascript/packs/plugins/datatables-fixedheader/js/dataTables.fixedHeader.js");
module.exports = __webpack_require__(/*! /Users/jazzzz/Development/eData/data_analysis/app/javascript/packs/plugins/datatables-fixedheader/js/dataTables.fixedHeader.min.js */"./app/javascript/packs/plugins/datatables-fixedheader/js/dataTables.fixedHeader.min.js");


/***/ })

/******/ });
//# sourceMappingURL=dataTables-eb473c99f429e45862dc.js.map