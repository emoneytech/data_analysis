...
/* WEBPACK VAR INJECTION */(function($) {!(function webpackMissingModule() { var e = new Error("Cannot find module './plugins/datatables-bs4/css/dataTables.bootstrap4.min.css'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
!(function webpackMissingModule() { var e = new Error("Cannot find module './plugins/datatables-responsive/css/responsive.bootstrap4.min.css'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
!(function webpackMissingModule() { var e = new Error("Cannot find module './plugins/datatables-buttons/css/buttons.bootstrap4.min.css'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
document.addEventListener("turbolinks:load", function () {
  if (dataTables.length === 0 && $('.data-table').length !== 0) {
    $('.data-table').each(function (_, element) {
...
/******/ });
//# sourceMappingURL=datatables-809e95a8c71a6f7a11c3.js.map